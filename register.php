...
<div class="login-form">
    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="text-center mb-4">
            <h1 class="h3 mb-0">Por favor regístrese</h1>
        ...
        <div class="row mx-gutters-2 mb-4">
            ...
            <div class="col-sm-6">
            <button type="button" class="btn btn-block btn-sm btn-google" style="background-color: #DB4437;"><i class="fa fa-google mr-2"></i>
